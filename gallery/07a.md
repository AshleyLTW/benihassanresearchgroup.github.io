---
layout: post
title: Autobiography of Khnumhotep II on the east wall, lines 1-13, from the tomb of Khnumhotep II at Beni Hassan
...
The (auto)biography of Khnumhotep II is incised on sunk relief below the coloured dado on the lower part of all four walls of the chapel. The (auto)biography begins on the east wall, north of the shrine and runs anti-clockwise, ending on the east wall, south of the shrine. On the south wall between lines 160 and 161 is a small false door carved in bas-relief <Kanawati & Evans, BH1, Pl. 11b.:Beni Hassan::12th Dynasty:Khnumhotep II (Tomb 3):Chapel:Architectural feature:South wall:Lower section:False door with cavetto cornice:::>. The inscription reads:
